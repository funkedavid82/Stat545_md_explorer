...
![](cm006-exercise_files/figure-markdown_github/unnamed-chunk-12-1.png) 5. Optional: git stage and commit
...
![](cm006-exercise_files/figure-markdown_github/unnamed-chunk-17-2.png) \#\#\#It shows a bimodal distribution 2. Add the point geom to `b`. Why is this an ineffective plot?
...
![](cm006-exercise_files/figure-markdown_github/unnamed-chunk-23-1.png)
...
![](cm006-exercise_files/figure-markdown_github/unnamed-chunk-23-2.png)

``` r
c + geom_line(aes(group=country))
```

![](cm006-exercise_files/figure-markdown_github/unnamed-chunk-23-3.png)
...
![](cm006-exercise_files/figure-markdown_github/unnamed-chunk-23-4.png)

``` r
c + geom_line(aes(group=country), alpha=0.2)
```

![](cm006-exercise_files/figure-markdown_github/unnamed-chunk-23-5.png)
